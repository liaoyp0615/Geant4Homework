...
void B1RunAction::EndOfRunAction(const G4Run* run)
{
  ...
  G4double Alldose = 0.08 * Alledep / All_mass;
  G4double AllrmsDose = 0.08 * Allrms / All_mass;
  G4double Tumordose = 0.12 * Tumoredep / Tumor_mass;
  G4double TumorrmsDose = 0.12 * Tumorrms / Tumor_mass;
  G4double Bodydose = 0.05 * Bodyedep / Body_mass;
  G4double BodyrmsDose = 0.05 * Bodyrms / Body_mass;
  G4double Headdose = 0.05 * Headedep / Head_mass;
  G4double HeadrmsDose = 0.05 * Headrms / Head_mass;
