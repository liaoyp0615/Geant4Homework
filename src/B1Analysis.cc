...
void B1Analysis::Fill(G4double x, G4double y, G4double z, G4double e, G4double w,
                      G4double tx, G4double ty, G4double tz, G4double te, G4double tw,
                      G4double bx, G4double by, G4double bz, G4double be, G4double bw,
                      G4double hx, G4double hy, G4double hz, G4double he, G4double hw)
{
  fx=x; fy=y; fz=z; fe=e; fw=w;
  ftx=tx; fty=ty; ftz=tz; fte=te; ftw=tw;
  fbx=bx; fby=by; fbz=bz; fbe=be; fbw=bw;
  fhx=hx; fhy=hy; fhz=hz; fhe=he; fhw=hw;
