...
fTumorLogicVolume(0),fBodyLogicVolume(0),fHeadLogicVolume(0),
fTumorPhyVolume(0),fBodyPhyVolume(0),fHeadPhyVolume(0)
{ }
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
...
{  
	...
	*/
	...
	logicShape_union->SetVisAttributes(neckVis);
	...
	fTumorLogicVolume = logicShape_tumor;
	fBodyLogicVolume = logicShape_body;
	fHeadLogicVolume = logicShape_union;
	
	// Set physical volume
	fTumorPhyVolume = phyShape_tumor;
	fBodyPhyVolume = phyShape_body;
	fHeadPhyVolume = phyShape_union;
